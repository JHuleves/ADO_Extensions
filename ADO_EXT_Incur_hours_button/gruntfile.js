module.exports = function (grunt) {
    grunt.initConfig({
        ...
        exec: {
            package_dev: {
                command: "npx tfx-cli extension create --manifest-globs vss-extension.json --rev-version --overrides-file configs/dev.json --output-path Fliles_for_VSIX/ADO_Time_Sheet_Entry.vsix",
                stdout: true,
                stderr: true
            },
            package_release: {
                command: "npx tfx-cli extension create --manifest-globs vss-extension.json --rev-version --overrides-file configs/release.json --output-path Fliles_for_VSIX/ADO_Time_Sheet_Entry.vsix",
                stdout: true,
                stderr: true
            },
            publish_dev: {
